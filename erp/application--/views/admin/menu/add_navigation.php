...
<script type="text/javascript" src="<?= base_url() ?>assets/plugins/fontawesome/js/fontawesome-iconpicker.js"></script>
...
<div class="panel panel-custom" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form" action="<?php echo base_url(); ?>admin/navigation/save_navigation/<?php if (!empty($menu_info->menu_id)) {
...
?>
            ...
            <div class="form-group">
                <label for="field-2" class="col-sm-3 control-label">Link<span class="required"> *</span></label>
                <div class="col-sm-5">
                ...
                <div class="col-sm-5">
                    <select name="parent" class="form-control select_box">
                        ...
                        <?php if (count($nav)) : foreach ($nav as $v_nav) : ?>
                                <option value="<?php echo $v_nav->menu_id ?>" <?php echo $menu_info->parent == $v_nav->menu_id ? 'selected' : '' ?>>
