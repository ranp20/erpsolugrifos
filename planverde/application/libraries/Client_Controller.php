...
class Client_Controller extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        $uri = null;
        $except_uri = array('client/settings/update_profile', 'client/settings/profile_updated', 'client/settings/set_password', 'client/settings/change_email', 'client/settings/change_username', 'client/settings/activities', 'client/settings/updated_aQ', 'client/settings/form_change_password', 'client/settings/set_password_aQ', 'client/settings/upload_photo', 'client/settings/update_photo');
