...
<form data-parsley-validate="" novalidate="" action="<?php echo base_url() ?>login" method="post">
    <div class="form-group has-feedback">
        <input type="text" name="user_name" id="user_name" required="true" class="form-control" placeholder="Usuario" autocomplete="true"/>
        <span class="fa fa-envelope form-control-feedback text-muted"></span>
    </div>
    <div class="form-group has-feedback ipt-psslogg_plv">
        <input type="password" name="password" required="true" autocomplete="true" class="form-control" placeholder="Contraseña" />
        <span class="fa fa-lock form-control-feedback text-muted"></span>
        <span id="icon-loginPassControl">
    ...
    ?>
    <button type="submit" class="btn btn-primary <?= $class ?> btn-flat">
        <span>INGRESAR</span>
