...
class Settings extends Client_Controller{
    ...
    public function update_profile(){
        $data['title'] = "Datos de perfil";
        $data['subview'] = $this->load->view('client/update_profile', $data, TRUE);
        $this->load->view('client/_layout_main', $data);
    }

    /* public function form_change_password(){
        $data['title'] = "Cambiando Contraseña";
        $data['subview'] = $this->load->view('client/form_change_pass', $data);
    ...
    public function updated_aQ(){
        ...
        // RECOGEMOS EL ID CLIENTE
        $id = $this->db->where(['user_id' => $this->session->userdata('user_id')])->get('tbl_account_details')->row()->company;

        $this->client_model->_table_name = 'tbl_cliente';
        $this->client_model->_primary_key = "cliente_id";
    ...
    public function upload_photo(){
        $data['title'] = "Actualizar foto de perfil";
        $data['profile_info'] = profile();
        $this->load->view('client/settings/photo', $data);
    }
    public function update_photo(){
        ...
        if (!empty($_FILES['avatar']['name'])) {
            ...
            $val == TRUE || redirect('client/dashboard');
            $profile_data['avatar'] = $val['path'];
            ...
            $type = 'error';
            $message = 'No selecciono una imagen para subir';
        }

        set_message($type, $message);
        redirect('client/dashboard');

        /* $data['json'] = ['type' => $type, 'message' => $message];
