                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <span data-placement="top" data-toggle="tooltip" title="DESCARGAR DOCUMENTO DE OC">
                        <a target="_blank" class="btn btn-success btn-lg" href="<?php echo base_url('admin/cotizacion/ot_pdf/'.$data_ot->cotizacion_ot_id)?>"><span class="fa fa-download"> DESCARGAR</span></a>
                      </span>
                    </div>
                  </div>
