<aside class="aside cSidLeftDash">
    <?php
                        ...
                        <div class="item user-block">
                            <div class="user-block-picture">
                                <div class="user-block-status">
                                    <img src="<?= base_url() . $profile_info->avatar ?>" alt="Avatar" width="60" height="60" class="img-fluid img-thumbnail img-circle">
                            ...
                            foreach ($v_module_info as $v_module) { ?>
                                        ...
                                        <li class="pinned_list">
                                            <a title="<?= lang('pinned') . ' ' . lang($module) ?>" data-placement="top" data-toggle="tooltip" href="<?= base_url() ?>admin/projects/project_details/<?= $project_info->project_id ?>">
                                                ...
                                                <div class="progress progress-xxs mb-lg ">
                                                    <div class="progress-bar progress-bar-<?php echo ($progress >= 100) ? 'success' : 'primary'; ?>" style="width: <?= $progress ?>%;"></div>
                                                </div>
                                            </a>
                                        </li>
                                    <?php } ?>
                                ...
                                <?php if ($v_module->module_name == 'tasks') {
                                    ...
                                    if (!empty($task_info)) {
                                        ...
                                        <li class="pinned_list mb">
                                            <a title="<?= lang('pinned') . ' ' . lang($module) ?>" data-placement="top" data-toggle="tooltip" href="<?= base_url() ?>admin/tasks/view_task_details/<?= $task_info->task_id ?>">
                                                <span style="font-size: 12px;"><?= $task_info->task_name ?></span>
                                                <div class="progress progress-xxs mb-lg ">
                                                    <div class="progress-bar progress-bar-<?php echo ($task_info->task_progress >= 100) ? 'success' : 'primary'; ?>" style="width: <?= $task_info->task_progress ?>%;"></div>
                                                </div>
                                            </a>
                                        </li>
                                    <?php } ?>
                                ...
                                <?php if ($v_module->module_name == 'estimates') {
                                    ...
                                    if (!empty($estimates_info)) {
                                        ?>
                                        <li class="pinned_list mb">
                                            <a title="<?= lang('pinned') . ' ' . lang($module) ?>" data-placement="top" data-toggle="tooltip" href="<?= base_url() ?>admin/estimates/index/estimates_details/<?= $estimates_info->estimates_id ?>">
                                ...
                                <?php if ($v_module->module_name == 'tickets') {
                                    ...
                                    if (!empty($tickets_info)) {
                                        ...
                                        ?>
                                        <li class="pinned_list mb">
                                            <a title="<?= lang('pinned') . ' ' . lang($module) ?>" data-placement="top" data-toggle="tooltip" href="<?= base_url() ?>admin/tickets/index/tickets_details/<?= $tickets_info->tickets_id ?>">
