...
<head>
    ...
    <!--<link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/summernote/summernote.min.css" rel="stylesheet"-->
    <!--      type="text/css">-->
    ...
    <!-- STYLES CUSTOMS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/css/customs/styles.css" rel="stylesheet">
</head>
