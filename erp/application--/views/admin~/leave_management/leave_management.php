...
if (!empty($all_category)) {
    ...
    <script type="text/javascript" src="<?= base_url() ?>assets/plugins/Flot/jquery.flot.pie.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>assets/plugins/Flot/jquery.flot.time.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>assets/plugins/Flot/jquery.flot.categories.js"></script>
