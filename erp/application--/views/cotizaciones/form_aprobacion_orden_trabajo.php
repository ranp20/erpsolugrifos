<div class="panel panel-custom">
  <header class="panel-heading ">
    ...
    APROBACION DE ORDEN DE TRABAJO
  </header>
  ...
  <div class="form-group">
    <label class="col-lg-3 control-label" for="aprobar">Aprobar Orden</label>
...
<?php  ?>
  <div class="form-group">
    ...
    <div class="col-lg-5 checkbox">
      <input data-id="" data-toggle="toggle" name="" id="active-achivo" value="1"  data-on="SI" data-off="NO" data-onstyle="success btn-xs" data-offstyle="danger btn-xs" type="checkbox">
    </div>
  </div>
