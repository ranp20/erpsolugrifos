...
?>
    <a class="btn btn-primary" data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/visita_tecnica/add_visita"><i class="fa fa-plus"></i> Valorizacón Visita Técnica </a>
<?php endif; ?>
            ...
            <tbody>
                <script type="text/javascript">
                    $(document).ready(function() {
                        list = base_url + "admin/visita_tecnica/visita_tecnica_list/";
