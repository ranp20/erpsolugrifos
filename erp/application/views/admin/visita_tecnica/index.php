...
<a class="btn btn-primary btn_addItem" data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/visita_tecnica/add_visita">
    <i class="fa fa-plus"></i>
    <span> Valorizacón Visita Técnica </span>
</a>
<?php endif; ?>
