...
?>
    <a class="btn btn-primary" data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/valorizacion_servicio/add_valorizacion"><i class="fa fa-plus"></i> Valorizacón de Servicio </a>
<?php endif; ?>
