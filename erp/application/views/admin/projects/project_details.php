...
<div class="row">
    ...
    <div class="col-sm-9 ">
        ...
        <div class="tab-content mt" style="border: 0;padding:0;">
            ...
            <div class="tab-pane <?= $active == 15 ? 'active' : '' ?>" id="project_calendar"
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body">
                        ...
                        <link rel="stylesheet" href="<?php echo base_url() ?>asset/css/fullcalendar.css" rel="stylesheet"
                              type="text/css">
                        <style type="text/css">
                            .datepicker {
            ...
            if (!empty($RTL)) {
                ?>
            <link rel="stylesheet" href="<?php echo base_url() ?>assets/plugins/ganttView/jquery.ganttViewRTL.css?ver=3.0.0"
                  rel="stylesheet">
                <script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/ganttView/jquery.ganttViewRTL.js"></script>
            <?php }else{
            ?>
            <link rel="stylesheet" href="<?php echo base_url() ?>assets/plugins/ganttView/jquery.ganttView.css?ver=3.0.0"
                  rel="stylesheet">
                <script type="text/javascript" src="<?php echo base_url() ?>assets/plugins/ganttView/jquery.ganttView.js"></script>
            <?php } ?>
