    ...
    <div class="col-lg-12">
        <form role="form" id="form" action="<?php echo base_url(); ?>admin/settings/save_settings" method="post" class="form-horizontal">
            <section class="panel panel-custom">
                ...
                $can_do = can_do(111);
                if (!empty($can_do)) { ?>
                    <header class="panel-heading"><?= ucfirst(lang('company_details'));?></header>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= ucfirst(lang('company_name'));?> <span class="text-danger">*</span></label>
                            <div class="col-lg-7">
                                <input type="text" name="company_name" class="form-control" value="<?= $this->config->item('company_name') ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= ucfirst(lang('company_legal_name'));?> <span class="text-danger">*</span></label>
                            <div class="col-lg-7">
                                <input type="text" name="company_legal_name" class="form-control" value="<?= $this->config->item('company_legal_name') ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= ucfirst(lang('contact_person'));?> </label>
                            <div class="col-lg-7">
                                <input type="text" class="form-control" value="<?= $this->config->item('contact_person') ?>" name="contact_person">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= ucfirst(lang('company_address'));?> <span class="text-danger">*</span></label>
                            <div class="col-lg-7">
                                <textarea class="form-control" name="company_address" required><?= $this->config->item('company_address') ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= ucfirst(lang('country'));?></label>
                            <div class="col-lg-7">
                        ...
                        <!--
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= ucfirst(lang('company_vat'));?></label>
                            <div class="col-lg-7">
                        ...
                        -->
                        <div class="form-group">
                            <label class="col-lg-3 control-label"><?= ucfirst(lang('company_ruc'));?></label>
                            <div class="col-lg-7">
                                <input type="text" class="form-control" value="<?= $this->config->item('company_ruc') ?>" name="company_ruc">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
