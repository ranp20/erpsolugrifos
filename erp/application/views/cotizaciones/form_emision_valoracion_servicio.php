<div class="panel panel-custom">
  <header class="panel-heading ">
    ...
    EMISION DE VALORACION DE SERVICIO
  </header>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-5 checkbox">
      <input data-id="" data-toggle="toggle" name="archivo" id="active-achivo" value="1"  data-on="SI" data-off="NO" data-onstyle="success btn-xs" data-offstyle="danger btn-xs" type="checkbox">
    </div>
  </div>
