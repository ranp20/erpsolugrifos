        ...
        <div class="panel panel-custom">
            ...
            <div class="col-sm-9">
                <div class="form-group">
                    <label class="col-lg-4 control-label"><?= 'Selleccionar Area' ?>
                        <span
                    ...
                    <div class="col-lg-8">
                        <select class="form-control select_box" style="width: 100%" name="departments_id"
                                id="new_departments">
                            <option value=""><?= 'Nueva Area' ?></option>
                ...
                <div class="form-group new_departments"
                    ...
                    <label class="col-sm-4 control-label"><?= 'Nueva Area' ?></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class=" col-sm-4 control-label"><?= 'Sub area' ?><span
