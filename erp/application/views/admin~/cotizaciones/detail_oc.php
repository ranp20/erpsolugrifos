              ...
              <div class="col-md-12 br">
                ...
                <form class="form-horizontal p-20">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <span data-placement="top" data-toggle="tooltip" title="DESCARGAR DOCUMENTO DE OC">
                        <a target="_blank" class="btn btn-success btn-lg" href="<?php echo base_url() ?>uploads/cotizaciones/orden_compra/<?php echo $data_oc->ruta ?>"><span class="fa fa-download"> DESCARGAR</span></a>
                      </span>
                    </div>
                  </div>
