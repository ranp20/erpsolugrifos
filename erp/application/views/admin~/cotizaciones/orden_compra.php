  ...
  <div class="col-sm-12">
    ...
    <div class="panel panel-custom">
      <header class="panel-heading ">
        <div class="panel-title"><strong>Cotización - Orden Compra</strong></div>
      </header>
          ...
          <tbody>
            <script type="text/javascript">
              $(document).ready(function() {
                let tipo = $("#tipo").val()
                list = base_url + "admin/cotizacion/cotizacion_orden_compra_list/<?php echo (isset($action) ? $action : '') ?>";
