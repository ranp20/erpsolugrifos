    ...
    <div class="tab-pane active" id="task_details" style="position: relative;">
      <div class="panel panel-custom">
        ...
        <div class="panel-body form-horizontal ">
          ...
          // $visita_tecnica_info = $this->db->where('visita_tecnica_id', $constancia_detail->visita_tecnica_id)->get('tbl_visita_tecnica')->row();
              ...
              <div class="col-md-12 br">
                ...
                <form class="form-horizontal p-20">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <?php
                      if (!empty($visita_tecnica_info->numero)) {
                        echo $visita_tecnica_info->numero;
                      }
                      ?>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <?php
                      if (!empty($visita_tecnica_info->servicio)) {
                        echo $visita_tecnica_info->servicio;
                      }
                      ?>
                    </div>
                  </div>
                  ...
                  if ($constancia_detail->fecha_visita < date('Y-m-d')) {
                    $text = 'text-danger';
                  } else {
                    $text = 'text-success';
                  }
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8 <?= $text ?>">
                      <strong><?= strftime('%d, %B, %Y', strtotime($constancia_detail->fecha_visita)) ?>
                      </strong>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <?php
                      $disabled = null;
                      if (!empty($constancia_detail->status)) {
                        if ($constancia_detail->status == 'completed') {
                          $status = "<div class='label label-success'>" . lang($constancia_detail->status) . "</div>";
                          $disabled = 'disabled';
                        } elseif ($constancia_detail->status == 'in_progress') {
                          $status = "<div class='label label-primary'>" . lang($constancia_detail->status) . "</div>";
                        } elseif ($constancia_detail->status == 'cancel') {
                          $status = "<div class='label label-danger'>" . lang($constancia_detail->status) . "</div>";
                        } else {
                          $status = "<div class='label label-warning'>" . lang($constancia_detail->status) . "</div>";
                        } ?>
                        <?= $status; ?>
                      <?php }
                      ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <span data-placement="top" data-toggle="tooltip" title="DESCARGAR DOCUMENTO DE VALORIZACION DE VISITA TECNICA">
                        <a target="_blank" class="btn btn-success btn-lg" href="<?php echo base_url() ?>uploads/visita_tecnica/constancia_visita/<?php echo $constancia_detail->ruta ?>"><span class="fa fa-download"> DESCARGAR</span></a>
                      </span>
                    </div>
                  </div>
