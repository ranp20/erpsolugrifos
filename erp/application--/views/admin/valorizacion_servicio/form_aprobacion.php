<div class="panel panel-custom">
  <header class="panel-heading ">
    ...
    APROBACIÓN DE VALORACION DE SERVICIO
  </header>
  <?php echo form_open(base_url('admin/valorizacion_servicio/save_forms/' . $form . '/' . $id), array('id' => 'valorizacion_servicio', 'class' => 'form-horizontal', "enctype" => "multipart/form-data")); ?>
  ...
  <?php /* ?>
  <div class="form-group">
    <label class="col-lg-3 control-label" for="aprobar">Aprobar Valoración</label>
    <div class="col-lg-5">
