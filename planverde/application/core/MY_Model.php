...
class MY_Model extends CI_Model{
    ...
    /********************** SUBIDA/ACTUALIZACIÓN DEL LOGOS DEL SITIO WEB(PLANVERDE) **********************/
    function uploadImage_companylogo($field){
    ...
    /********************** SUBIDA/ACTUALIZACIÓN DEL FAVICON DEL SITIO WEB(PLANVERDE) **********************/
    function uploadImage_favicon($field){
    ...
    /********************** SUBIDA/ACTUALIZACIÓN DEL FONDO DEL LOGIN DEL SITIO WEB(PLANVERDE) **********************/
    function uploadImage_bgcklogin($field){
        $config['upload_path'] = 'uploads/background-login/';
        $config['allowed_types'] = config_item('allowed_files');
        $config['max_size'] = config_item('max_file_size') * 1024;
        $config['overwrite'] = TRUE;
        $this->load->library('upload', $config);
