      ...
      <?php if ($display == 'logo' || $display == 'logo_title') { ?>
        <a href="#/" class="navbar-brand cNav-header__link">
          <div class="brand-logo cNav-header__link--cLogo">
            <img src="<?= base_url() . 'assets/img/logo-interno.png' ?>" alt="App Logo" class="img-responsive">
          </div>
          <div class="brand-logo-collapsed cNav-header__link--cLogo--collapsed">
            <img src="<?= base_url() . 'assets/img/plan-verde.jpg' ?>" alt="App Logo" class="img-responsive">
          </div>
        </a>
      <?php }
      ?>
      ...
      <ul class="nav navbar-nav cNav-wrapper__lft cHTopNav__c__navWrapper__lft">
        ...
        <li class="hidden-xs cNav-wrapper__lft--cLogo">
          <a href="" class="text-center">
            <img src="<?= $urlPlanVerde;?>/uploads/solugrifos.png" class="img-fluid" width="100" height="100" alt="">
          </a>
        </li>
      </ul>
      <ul class="nav navbar-nav navbar-right cNav-wrapper__rgt cHTopNav__c__navWrapper__rgt">
        <li class="visible-lg">
          <a href="#" data-toggle-fullscreen="" id="btn_toggfullscreen" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Pantalla completa">
        ...
        <li class="dropdown user user-menu cNav-wrapper__rgt--cUsrMenu">
          ...
          <ul class="dropdown-menu animated zoomIn">
            ...
            <li class="user-footer">
              <?php /*?>
              <div class="pull-left">
                  <a href="<?= base_url() ?>client/settings/form_change_password"
                      class="btn btn-default btn-flat"  data-toggle="modal" data-target="#myModal">Cambiar Contraeña</a>
              </div>
              <?php */ ?>
              <div class="pull-right">
                <a href="<?= base_url() ?>login/logout" class="btn btn-default btn-flat">Cerrar session</a>
              </div>
            </li>
          </ul>
        </li>
        <!-- <li>
          <a href="#" data-toggle-state="offsidebar-open" data-no-persist="true" style="font-size:15px;">
            <em class="fa fa-calculator"></em>
            <small class="label" style="top: 11%;position: absolute;right: 5%;">
            <?php
              /*
...
$("#btn_toggfullscreen").on('click', function() {
	if(IsFullScreenCurrently())
		GoOutFullscreen();
	else
		GoInFullscreen($("#cBtn_toggfullscreen").get(0));
});
