    ...
    <div class="panel panel-custom">
      <header class="panel-heading ">
        <div class="panel-title">
          <strong>Cotización - Orden Trabajo ( REPORTE )
          </strong>
        </div>
      </header>
        ...
        <table class="table table-striped DataTables bulk_table" id="DataTables" cellspacing="0" width="100%">
          <thead>
            <tr>
              ...
              <th class="col-sm-1">Area Asignada</th>
              <th> Valorizacion </th>
              <th> Monto </th>
              <th> Estado </th>
          ...
          <tbody>
            <script type="text/javascript">
              $(document).ready(function() {
                let tipo = $("#tipo").val()
                list = base_url + "admin/cotizacion/cotizacion_orden_trabajo_report_list/<?php echo (isset($action) ? $action : '') ?>";
