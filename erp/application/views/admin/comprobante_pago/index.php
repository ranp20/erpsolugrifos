  ...
  <div class="col-sm-12">
    <div class="panel panel-custom">
      <header class="panel-heading ">
        ...
        <?php if(in_array($this->session->userdata('designations_id'), [1, 2, 3])): ?>
        <a class="btn btn-primary" target="_blank" href="<?= base_url() ?>admin/comprobante_pago/report"><i class="fa fa-file-excel-o"></i> Reporte de Pagos</a>
        <?php endif; ?>
        </div>
      </header>
