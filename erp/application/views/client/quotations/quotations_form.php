...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content bg-white">
        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
            ...
            <script type="text/javascript" src="<?= base_url() ?>asset/vendor/js/vendor.js"></script>
            <script type="text/javascript" src="<?= base_url() ?>plugins/formbuilder/formbuilder.js"></script>
