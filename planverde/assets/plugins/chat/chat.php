...
//                            $('#conversation_chat_' + chat.chatid).scrollTop($('#conversation_chat_' + chat.chatid)[0].scrollHeight);
    ...
    function build_chat_area(data) {
        ...
        $('#open_chat_box_' + data.chatid).append('<div class="panel-footer b0 chat-input-box"><input type="text" name="reply" class="form-control" id="chat_input_message_' + data.chatid + '" placeholder="Escriba un mensaje y luego presione Entrar" onkeypress="return send_message(event, ' + data.chatid + ');"></div>');
