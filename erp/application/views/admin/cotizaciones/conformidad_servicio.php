  ...
  <div class="col-sm-12">
    ...
    <div class="panel panel-custom">
      <header class="panel-heading ">
        <div class="panel-title"><strong>Cotización - Conformidad Servicio</strong></div>
      </header>
          ...
          <tbody>
            <script type="text/javascript">
              $(document).ready(function() {
                let tipo = $("#tipo").val()
                list = base_url + "admin/cotizacion/cotizacion_conformidad_servicio_list/<?php echo (isset($action) ? $action : '') ?>";
