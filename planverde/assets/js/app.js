...
$(document).ready(function(){
  const cookieName = "siderbarLeftToggleMenu";
  ...
  // Verifica si la cookie existe y establece la clase en consecuencia
  const cookieValue = getCookie(cookieName);
  if (cookieValue === "true"){
    $(elementSelector).addClass("collapse-menu");
  }
  // Añade un evento para alternar la clase y almacenar el estado en la cookie
  $("#toggMenuSidebarLeft").on("click", function(e){
    $(elementSelector).toggleClass("collapse-menu");
    const hasClass = $(elementSelector).hasClass("collapse-menu");
    setCookie(cookieName, hasClass, 365); // Almacena la cookie durante 1 año
  });
});
*/
