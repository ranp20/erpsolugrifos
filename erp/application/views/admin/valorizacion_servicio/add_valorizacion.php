<div class="panel panel-custom">
  ...
  <?php echo form_open(base_url('admin/valorizacion_servicio/save_valorizacion'), array('id' => 'valorizacion_servicio', 'class' => 'form-horizontal', "enctype" => "multipart/form-data")); ?>
