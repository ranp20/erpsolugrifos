        ...
        <div style="border: 1px solid blue; border-radius: 5px; margin:5px;">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5 col-xs-12">
              ...
              ?>
                <input type="" name="tfecha[<?php echo $adelanto->cotizacion_pago_id; ?>]" class="form-control start_date" placeholder="0.00" data-toggle="toggle" data-onstyle="success btn-xs" data-offstyle="danger btn-xs" class="">
              <?php
              } else {
              ?>
      ...
      <div style="border: 1px solid blue; border-radius: 5px; margin:5px;">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5 col-xs-12">
            ...
            ?>
              <input type="" name="tfecha[<?php echo $document->cotizacion_pago_id; ?>]" class="form-control start_date" placeholder="dd/mm/aaaa" data-toggle="toggle" data-onstyle="success btn-xs" data-offstyle="danger btn-xs" class="">
            <?php
            } else {
            ?>
