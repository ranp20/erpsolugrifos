                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/transactions/deposit" class="mt0 mb0"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/transactions/expense" class=" small-box-footer"><?= lang('more_info') ?>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/invoice/manage_invoice" class="mt0 mb0"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/invoice/all_payments" class=" small-box-footer"><?= lang('more_info') ?>
                                                            <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/invoice/all_payments" class="mt0 mb0"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/invoice/manage_invoice" class="small-box-footer"><?= lang('more_info') ?>
                                                            <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/tickets" class=" small-box-footer"><?= lang('more_info') ?>
                                                            <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/bugs" class="mt0 mb0"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    ...
                                                    <small><a href="<?= base_url() ?>admin/projects" class="small-box-footer"><?= lang('more_info') ?>
                                                            <i class="fa fa-arrow-circle-right"></i></a></small>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <section class="panel panel-custom menu">
                            <aside class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class=""><a href="#projects" data-toggle="tab"><?= lang('overdue') . ' ' . lang('project') ?>
                                    ...
                                    <li class=""><a href="#estimate" data-toggle="tab"><?= lang('expired') . ' ' . lang('estimate') ?>
                                            <strong class="pull-right ">(<?= $estimate_overdue ?>)</strong>
                                        </a></li>
                                    <li class=""><a href="#bugs" data-toggle="tab"><?= lang('unconfirmed') . ' ' . lang('bugs') ?>
                                            <strong class="pull-right ">(<?= $bug_unconfirmed ?>)</strong>
                                        </a></li>
                                    <li class=""><a href="#recent_opportunities" data-toggle="tab"><?= lang('overdue') . ' ' . lang('opportunities') ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="progress progress-xs progress-striped active">
                                                                            <div class="progress-bar progress-bar-<?php echo ($progress >= 100) ? 'success' : 'primary'; ?>" data-toggle="tooltip" data-original-title="<?= $progress ?>%" style="width: <?= $progress; ?>%"></div>
                                                                        </div>
                                            ...
                                            <table class="table table-striped m-b-none text-sm" id="datatable_action">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    <td>
                                                                        <a class="text-info" href="<?= base_url() ?>admin/tasks/view_task_details/<?= $v_task->task_id ?>"><?= $v_task->task_name ?></a>
                                                                        <?php if (strtotime(date('Y-m-d')) > strtotime($v_task->due_date) && $v_task->task_progress < 100) { ?>
                                                                            <span class="label label-danger pull-right"><?= lang('overdue') ?></span>
                                                                        <?php } ?>

                                                                        <div class="progress progress-xs progress-striped active">
                                                                            <div class="progress-bar progress-bar-<?php echo ($v_task->task_progress >= 100) ? 'success' : 'primary'; ?>" data-toggle="tooltip" data-original-title="<?= $v_task->task_progress ?>%" style="width: <?= $v_task->task_progress; ?>%"></div>
                                                                        </div>
                                        ...
                                        <div class="tab-pane" id="invoice">
                                            <table class="table table-striped m-b-none text-sm" id="datatable_action">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    <td><a class="text-info" href="<?= base_url() ?>admin/invoice/manage_invoice/invoice_details/<?= $v_invoices->invoices_id ?>"><?= $v_invoices->reference_no ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    ...
                                                                    <td><span class="label label-<?= $label ?>"><?= lang($opportunities_state_info->opportunities_state) ?></span>
                                                                    </td>
                                                                    <td><?php
                            ...
                            <?php if ($this->session->userdata('user_type') == '1') { ?>
                                <footer class="panel-footer bg-white no-padder">
                                    <div class="row text-center no-gutter">
                                        ...
                                        <div class="col-xs-2 b-r b-light">
                                            <span class="h4 font-bold m-t block"><?= count($this->db->where('task_status', 'completed')->get('tbl_task')->result()) ?>
                                            </span>
                                        ...
                                        <div class="col-xs-2">
                                            ...
                                            <small class="text-muted m-b block"><?= lang('total') . ' ' . lang('estimate') ?></small>

                                        </div>
                                        <div class="col-xs-2">
                                            <span class="h4 font-bold m-t block"><?= count($this->db->where('bug_status', 'resolved')->get('tbl_bug')->result()) ?>
                                            </span>
                                            <small class="text-muted m-b block"><?= lang('resolved') . ' ' . lang('bugs') ?></small>

                                        </div>
                                        <div class="col-xs-2">
                                            <span class="h4 font-bold m-t block"><?= count($this->db->where('stages', 'won')->get('tbl_opportunities')->result()) ?>
                                            </span>
                                            <small class="text-muted m-b block"><?= lang('won') . ' ' . lang('opportunities') ?></small>
                        ...
                        <div class="panel panel-custom menu">
                            <header class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    <div class="pull-right hidden-xs" style="margin-top: -8px;">
                                        <form role="form" id="form" action="<?php echo base_url(); ?>admin/dashboard/index/finance_overview" method="post" class="form-horizontal form-groups-bordered">
                                            <div class="pull-left">
                                            ...
                                            <div class="pull-right">
                                                <button type="submit" style="font-size: 15px" data-toggle="tooltip" data-placement="top" title="Search" class="btn btn-custom"><i class="fa fa-search"></i></button>
                                            </div>
                                        </form>
                                    </div>
                                </h3>
                            ...
                            <div class="">
                                ...
                                <div class="col-sm-3 text-center">
                                    <span class="h4 font-bold m-t block"><?= display_money($total_annual['total_income'], $curency->symbol); ?></span>
                                    <small class="text-muted m-b block"><?= lang('total_annual') . ' ' . lang('income') ?></small>
                                </div>
                                <div class="col-sm-3 text-center">
                                    <span class="h4 font-bold m-t block"><?= display_money($total_annual['total_expense'], $curency->symbol); ?></span>
                                    <small class="text-muted m-b block"><?= lang('total_annual') . ' ' . lang('expense') ?></small>
                                </div>
                                <div class="col-sm-3 text-center ">
                                    <span class="h4 font-bold m-t block"><?= display_money($total_annual['total_profit'], $curency->symbol); ?></span>
                    ...
                    <div class="<?= $v_order->col ?> mt-lg" id="<?= $v_order->id ?>">
                        ...
                        <div class="panel panel-custom menu">
                            ...
                            <div class="panel-body">
                                <p class="text-center ">
                                <form role="form" id="form" action="<?php echo base_url(); ?>admin/dashboard/index/goal_month" method="post" class="form-horizontal form-groups-bordered hidden-xs">
                        ...
                        <div class="panel panel-custom menu" style="height: 437px;overflow-y: scroll;">
                            <header class="panel-heading mb0">
                                <h3 class="panel-title"><?= lang('to_do') . ' ' . lang('list') ?> |
                                    <a class="text-sm" target="_blank" href="<?= base_url() ?>admin/dashboard/all_todo"><?= lang('view_all') ?></a>
                                    <div class="pull-right " style="padding-top: 0px;padding-bottom: 8px">
                                        <a href="<?= base_url() ?>admin/dashboard/new_todo" class="btn btn-xs btn-success" data-toggle="modal" data-placement="top" data-target="#myModal_lg"><?= lang('add_new') ?></a>
                                    </div>
                                </h3>
                            </header>
                            <div class="">
                                                    ...
                                                    <tr class="sortable item" data-item-id="<?= $my_todo->todo_id ?>">
                                                        ...
                                                        <td>
                                                            <div class="complete-todo checkbox c-checkbox ">
                                                                <label>
                                                                    <input type="checkbox" data-id="<?= $my_todo->todo_id ?>" style="position: absolute;" <?php
                                                                                                                                                            if ($my_todo->status == 3) {
                                                                                                                                                                echo 'checked';
                                                                                                                                                            }
                                                                                                                                                            ?>>
                                                        ...
                                                        <td>
                                                            <a <?php
                                                                ...
                                                                ?> class="text-info" data-toggle="modal" data-target="#myModal_lg" href="<?= base_url() ?>admin/dashboard/new_todo/<?= $my_todo->todo_id ?>">
                                                            ...
                                                            ?>
                                                                <small class="block" data-toggle="tooltip" data-placement="top"><?= lang('assign_by') ?><a class="text-danger" href="<?= base_url() ?>admin/user/user_details/<?= $my_todo->assigned ?>"> <?= $a_userinfo->fullname ?></a>
                                                                </small>
                                                            <?php } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?= $todo_label ?>
                                                            <div class="btn-group">
                                                                <button style="font-size:10px;padding:0px;margin-top: -1px" class="btn btn-xs btn-success dropdown-toggle" data-toggle="dropdown">
                                                                    <?= lang('change_status') ?>
                                                        ...
                                                        <td>
                                                            <strong data-toggle="tooltip" data-placement="top" title="<?= strftime(config_item('date_format'), strtotime($due_date)) ?>"><?= date("l", strtotime($due_date)) ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="text-info" href="<?= base_url() ?>admin/projects/project_details/<?= $v_my_project->project_id ?>"><?= $v_my_project->project_name ?></a>
                                                            <?php if (strtotime(date('Y-m-d')) > strtotime($v_my_project->end_date) && $v_my_project->progress < 100) { ?>
                                                                <span class="label label-danger pull-right"><?= lang('overdue') ?></span>
                                                            <?php } ?>

                                                            <div class="progress progress-xs progress-striped active">
                                                                <div class="progress-bar progress-bar-<?php echo ($v_my_project->progress >= 100) ? 'success' : 'primary'; ?>" data-toggle="tooltip" data-original-title="<?= $v_my_project->progress ?>%" style="width: <?= $v_my_project->progress; ?>%"></div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="col-sm-1">
                                                            <div class="complete checkbox c-checkbox">
                                                                <label>
                                                                    <input type="checkbox" data-id="<?= $v_my_task->task_id ?>" style="position: absolute;" <?php
                                                        ...
                                                        <td>
                                                            <a class="text-info" href="<?= base_url() ?>admin/tasks/view_task_details/<?= $v_my_task->task_id ?>">
                                                            ...
                                                            <div class="progress progress-xs progress-striped active">
                                                                <div class="progress-bar progress-bar-<?php echo ($v_my_task->task_progress >= 100) ? 'success' : 'primary'; ?>" data-toggle="tooltip" data-original-title="<?= $v_my_task->task_progress ?>%" style="width: <?= $v_my_task->task_progress; ?>%"></div>
                                                            </div>
                            ...
                            ?>
                                    <div class="notice-calendar-list panel-body">
                                        <div class="notice-calendar">
                                            <span class="month"><?php echo date('M', strtotime($v_announcements->created_date)) ?></span>
                                            <span class="date"><?php echo date('d', strtotime($v_announcements->created_date)) ?></span>
                                        </div>

                                        <div class="notice-calendar-heading">
                                            <h5 class="notice-calendar-heading-title">
                                                <a href="<?php echo base_url() ?>admin/announcements/announcements_details/<?php echo $v_announcements->announcements_id; ?>" title="View" data-toggle="modal" data-target="#myModal_lg"><?php echo $v_announcements->title ?></a>
                                            </h5>
                                        ...
                                        <div style="margin-top: 5px; padding-top: 5px; padding-bottom: 10px;">
                                            <span style="font-size: 10px;" class="pull-right">
                                                <strong>
                                                    <a href="<?php echo base_url() ?>admin/announcements/announcements_details/<?php echo $v_announcements->announcements_id; ?>" title="View" data-toggle="modal" data-target="#myModal_lg"><?= lang('view_details') ?></a></strong>
                                            </span>
                                        </div>
                                    </div>
                                <?php
                            ...
                            <section class="panel panel-custom menu" style="height: 437px;overflow-y: scroll;">
                                ...
                                <div class="panel-body inv-slim-scroll">
                                    <div class="list-group bg-white">
                                        ...
                                        ?>
                                                <a href="<?= base_url() ?>admin/invoice/manage_invoice/payments_details/<?= $v_paid->invoices_id ?>" class="list-group-item">
                                                    <?= !empty($invoices_info->reference_no) ? $invoices_info->reference_no : $v_paid->trans_id ?>
                                                    -
                                                    <small class="text-muted"><?= display_money($v_paid->amount, $v_paid->currency) ?>
                                                        <span class="label label-<?= $label ?> pull-right"><?= !empty($payment_method->method_name) ? $payment_method->method_name : '-'; ?></span>
                                                    </small>
                                                </a>
                                        <?php
                                            }
