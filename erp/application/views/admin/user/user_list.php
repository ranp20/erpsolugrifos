                    ...
                    <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
                        <form role="form" data-parsley-validate="" novalidate="" id="userform"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><strong>Nombres Completos </strong><span
                            ...
                            <?php if (empty($login_info->user_id)) { ?>
                                <div class="form-group">
                                    <label
                                            class="col-sm-3 control-label"><strong> <?= 'Nombre Usuario'; ?></strong><span
                                                class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><strong><?= 'contraseña' ?> </strong><span
                                                class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                        <input type="password" id="new_password" placeholder="<?= 'contraseña' ?>"
                                               name="password" class="input-sm form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label
                                            class="col-sm-3 control-label"><strong><?= 'confirmar Contraseña' ?> </strong><span
                                                class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                            ...
                            <?php } ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><strong><?= 'email' ?> </strong><span
                                            class="text-danger">*</span></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><strong><?= 'Celular' ?> </strong></label>
                                <div class="col-sm-5">
                                    <input type="text" class="input-sm form-control" value="<?php
                                    if (!empty($profile_info)) {
                            ...
                            <?php /** ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><strong><?= 'skype_id' ?> </strong></label>
                                <div class="col-sm-5">
                                    <input type="text" class="input-sm form-control" value="<?php
                                    if (!empty($profile_info)) {
                            ...
                            <?php */ ?>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><strong><?= 'Foto de perfil' ?></strong><span
                                            class="text-danger">*</span></label>
                                <div class="col-lg-5">
                                        ...
                                        <span class="btn btn-default btn-file">
                                            <span class="fileinput-new">
                                                <input type="file" name="avatar" value="upload"
                                                       data-buttonText="<?= 'Seleccionar Aefchivos' ?>" id="myImg"/>
                            ...
                            <div class="form-group">
                                <label for="field-1"
                                       class="col-sm-3 control-label"><strong><?= 'Tipo de Usuario' ?></strong><span
                            ...
                            <?php */ ?>
                            <input id="user_type" type="hidden" name="role_id" value="1">
                            <?php
                            ...
                            <div class="form-group" id="departmentt" <?php
                            // if (!empty($login_info) && $login_info->role_id != 2) {
                                echo 'style="display:block"';
                            // }
                            ?> >
                                <label class="col-sm-3 control-label"><strong><?= 'Rol Usuario' ?> </strong><span
                                            class="text-danger">*</span></label>
                                <div class="col-sm-5">
                                    <div class="input-groupp">
                                        <select class="form-control select_box department" required style="width: 100% !important"
                                                name="designations_id">
                                            <option value=""><?= 'Selecciona Rol Usuario'; ?></option>
                                            <?php
