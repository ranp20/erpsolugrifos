<a href="#" data-toggle="dropdown" style="font-size: 30px;">
...
<ul class="dropdown-menu animated zoomIn notifications-list" data-total-unread="<?php echo $unread_notifications; ?>" style="width: 350px">
                   ...
                   class="n-top n-link list-group-item <?php if ($notification->read_inline == 0) {
                    ...
                    <div class="n-box media-box ">
                        ...
                        <div class="media-box-body clearfix">
                            ...
                            <small class="text-muted pull-left" style="margin-top: -4px"><i class="fa fa-clock-o"></i> <?php echo time_ago($notification->date); ?></small>
