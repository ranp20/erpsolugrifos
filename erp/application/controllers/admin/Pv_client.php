...
class Pv_order extends Admin_Controller
{
  ...
  public function add_pv_client($id = NULL)
  {
  ...
  public function pvOrderList($type = NULL)
  {
    if ($this->input->is_ajax_request()) {
      ...
      foreach ($fetch_data as $_key => $pv_order) {
        ...
        $sub_array[] = $_key + 1;
        $popover = ($pv_order->comment) ? 'style="cursor:pointer" data-toggle="popover" title="Descripci贸n" data-content="' . $pv_order->comment . '"' : '';
